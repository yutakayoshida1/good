<!DOCTYPE html>
<!-- saved from url=(0053)https://www.Tasnic-Capital.com/ja/cabinet/mt4/deposit -->
...
<?php echo $__env->make('layouts.header2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<div class="container content-cabinet py-4">
		<div class="row">
            ...
            <div class="row">
                ...
                <?php echo $__env->make('personal.DepositsAndWithdrawals_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    </body></html><?php /**PATH /Applications/MAMP/htdocs/TasnicCapital/resources/views/personal/DepositsAndWithdrawals.blade.php ENDPATH**/ ?>