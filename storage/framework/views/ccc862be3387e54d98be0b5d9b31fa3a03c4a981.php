          ...
          <div class="mypage-detail-wrapper">
            ...
            <div class="my-page-form-group">
              <div class="d-flex-right">
                <span>お名前（ローマ字）</span> <input type="text" class="my-page-input1" value="<?php echo e($this_user_account_info->name); ?>">
              </div>

              <div class="d-flex-right">
                <span>メールアドレス</span> <input type="text" class="my-page-input1" value="<?php echo e($this_user_account_info->email); ?>" >
              </div>
...
<?php /**PATH E:\ready\japan project\laravel design\goodenoughtreasure.com\resources\views/my_page/additional.blade.php ENDPATH**/ ?>