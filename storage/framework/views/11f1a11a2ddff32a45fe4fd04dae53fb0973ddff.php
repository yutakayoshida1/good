        ...
        <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12  my-page-main-content">
          ...
          <div style="deposit-menu-wrapper ">
            ...
            <div  class="col-md-4 col-lg-4 col-sm-4 col-xs-12 d-flex-around margin-top-zero">
              <a href="<?php echo e(url('/my-deposit/cryptocurrency')); ?>" class="mypage-menu  mypage-menu-active deposit-menu">暗号通貨入金</a>
          ...
          <div class="mypage-detail-wrapper">
            ...
            <p class="subcontent">反映までの時間 : 着金確認即時　　手数料 : ５％<p>
            ...
            <div>
              ...
              <div style="display:flex; justity-content: center; margin:20px 0px">
                <input type="text" value="<?php echo e($thisCurrencyInfo->address); ?>" class="my-page-input per80"><div class="my-page-button my-page-button-green per20 clipboard_copy_btn">copy</div>
              </div>
...
<?php /**PATH E:\ready\japan project\laravel design\goodenoughtreasure.com\resources\views/my_page/deposit_cryptocurrency.blade.php ENDPATH**/ ?>