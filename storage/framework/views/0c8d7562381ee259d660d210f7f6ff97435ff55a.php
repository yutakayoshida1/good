<div style="text-align:center;">
    ...
    <br>
    <div style="background-color:red;color:white;border-color:1px;padding:3px;">
        <h3>振り込みに際してのご注意点</h3>
    </div>
    <br><br>
</div>
...
</div><?php /**PATH /Applications/MAMP/htdocs/GoodEnough3/resources/views/deposits_parts/bank.blade.php ENDPATH**/ ?>