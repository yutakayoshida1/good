					...
					<div class="consent-main">
						...
						<div class="row" style="margin-top: 20px;">
							<div class="center-align">
								<a href="<?php echo e(route('aff_spec_success')); ?>" class="btn btn-danger">パートナー登録</a>
							</div>
						</div>
					</div>
					<div class="black-div" style="position: relative;">
...
</html><?php /**PATH E:\Gitub project\good\resources\views/my_page/aff_spec_partner.blade.php ENDPATH**/ ?>