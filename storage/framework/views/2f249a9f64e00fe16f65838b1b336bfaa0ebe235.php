  ...
  <body style="margin: 0; padding:0">
    <div class="main-wrap">
      <div class="container-fruid">
        ...
        <div class="bg-image">
          <div class="row" style="z-index: 1">
            <div class="col-md-5 col-sm-5 col-xs-5 col-lg-5">
              <img src="./images/header_logo.png" class="banner-logo" width="40%">
              <div>
              <?php $__currentLoopData = $global->header_table_body; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                  <a class="common-button banner-button1" style="z-index:100" href="<?php echo e($row[1]); ?>"><?php echo e($row[0]); ?></a>
                </div>

                <?php elseif($row[0] == "デモ口座開設"): ?>
                <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                  <a class="common-button banner-button2" href="<?php echo e($row[1]); ?>"><?php echo e($row[0]); ?></a>
                </div>
                <?php endif; ?>
            ...
            <div class="col-md-5 col-sm-5 col-xs-12 col-lg-5 bg-text" style="text-align">
        ...
        <div class="row" id="sec-1-bg" style="background-image: url(./images/sec1_bg.png);
    background-size: 100% 9.5%; background-repeat: no-repeat;">
          <div class="sec-1" style="margin-top:3%;">
            <div class="col-md-4 col-sm-4 col-xs-4 col-lg-4" style="padding-left: 2%">
              <span class="back-opacity-div">REAL TIME TRADE RATE</span>
            </div>
            <div class="col-md-8 col-sm-8 col-xs-8 col-lg-8" style="padding-left: 2%">
...
<div>提供: <a href="https://ja.exchange-rates.org/" rel="nofollow">ja.exchange-rates.org</a></div>
        ...
        <div class="row hidden-xs" id="sec5-bg-image">
          <div class="sec5-text">
            <span class="sec5-heading">最大レバレッジ1000倍</span><br><br>
            <span>資金効率を高めるため、FX取引最大1000:1の取引を提供。真のDMA業者として、お客様の取引残高や司教によるレバレッジの一時的な変更は行ません</span><br>
          </div>
          <div class="sec5-text">
        ...
        <div class="row visible-xs-block" id="sec5-bg-image-sm">
          <div class="sec5-text">
            <span class="sec5-heading">最大レバレッジ500倍</span><br><br>
            <span>資金効率を高めるため、FX取引:最大500:1の取引を提供。真のDMA業者として、お客様の取引残高や司教によるレバレッジの一時的な変更は行ません</span><br>
          </div>
          <div class="sec5-text">
            <span class="sec5-heading">ゼロカット方式採用 安心の追証の請求なし</span><br><br>
            <span>相場の急激な変動により、お客様の残高がマイナスになった場合でも、追証・追加入金の必要はありません。当社では、マイナス残高をゼロリセット対応いたします。</span><br>
...
<?php /**PATH /home/r9920488/public_html/goodenoughtreasure.com/resources/views/top.blade.php ENDPATH**/ ?>