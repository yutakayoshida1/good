				...
				<div class="modal-header">
					...
					<ol class="list-group list-group-flush">
						<li class="list-group-item">
							...
							<a class="logo play-store" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2" target="_blank"><img src="<?php echo e($currentPath); ?>/MT4 管理画面 _ Tasnic-Capital _files/play-store.png"></a>
							<a class="logo app-store" href="https://itunes.apple.com/gb/app/google-authenticator/id388497605" target="_blank"><img src="<?php echo e($currentPath); ?>/MT4 管理画面 _ Tasnic-Capital _files/app-store.png"></a>
						</li>
						<li class="list-group-item">
							<b>2. Add your Tasnic-Capital Account to Google Authenticator </b>
							<p>If there are any existing Tasnic-Capital codes for <b>MT4 715238</b>, delete them. Scan the QR code bellow to add a Tasnic-Capital Account</p>
							...
							<br><a href="<?php echo e(route('setting')); ?>">Unable to scan the code?</a>
						...
						<li class="list-group-item">
							...
							<form method="POST" id="authvalidate" novalidate="" action="<?php echo e(route('two-factor-authenticate')); ?>">
								<?php echo csrf_field(); ?>
								<div class="input-group mb-3">
									<input type="hidden" name="secret" value="<?php echo e($google2fa_secret); ?>">
...
<?php /**PATH /Applications/MAMP/htdocs/TasnicCapital/resources/views/personal/2_factor_authenticate.blade.php ENDPATH**/ ?>