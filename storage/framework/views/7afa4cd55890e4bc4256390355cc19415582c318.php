    ...
    <div class="container-fruid">
      ...
      <div class="bg-image">
        <div class="row" style="z-index: 1; padding-bottom:30px">
          <div class="col-md-5 col-sm-12 col-xs-12 col-lg-5" id="logo_image">
            ...
            <div>
              ...
              <?php if($row[0] == trans('header.menu_new_account')): ?>
              <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <a class="common-button banner-button1" style="z-index:100" href="<?php echo e($row[1]); ?>"><?php echo e(trans('header.menu_new_account')); ?></a>
              </div>

              <?php elseif($row[0] == trans('header.menu_demo')): ?>
              <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
                <a class="common-button banner-button2" href="<?php echo e($row[1]); ?>"><?php echo e(trans('header.menu_demo')); ?></a>
              </div>
              <?php endif; ?>
          ...
          <div class="col-md-7 col-sm-12 col-xs-12 col-lg-7" id="com_image">
            <div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 text-center title-bg">
              <span><?php echo e(trans('top.top_banner')); ?></span>
            </div>
        ...
        <div class="row">
          <div class="col-md-5 col-sm-5 col-xs-12 col-lg-5 bg-text" style="text-align:right;">
            <span><?php echo e(trans('top.top_banner_sm_1')); ?></span><br>
            <span><?php echo e(trans('top.top_banner_sm_2')); ?></span>
          </div>
        </div>
      </div>
      ...
      <div id="osirase" class="row">
        <div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-8 col-xs-offset-2" id="gefx-information">
          <div id="gefx-information-title">
            <span><?php echo e(trans('top.top_news')); ?></span>
          </div>
      ...
      <div class="row padding-xx">
        <div class="section-text" id="section2-text">
          <span><?php echo e(trans('top.top_meta_intro_1')); ?></span><br>
          <span><?php echo e(trans('top.top_meta_intro_2')); ?></spna>
        </div>
      </div>
        ...
        <div class="col-md-6 col-lg-6 col-xs-12">
          ...
          <div class="row">
            <div class="text-center-sp mt-5">
              <a href="https://download.mql5.com/cdn/web/18024/mt4/goodenoughtreasure4setup.exe" class="common-button special-width"><?php echo e(trans('top.top_meta_btn')); ?></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row" style="margin: 10px 0;">
        <div class="section-text" id="section3-text">
          <span><?php echo e(trans('top.top_crypto_intro_1')); ?></span><br>
          <span><?php echo e(trans('top.top_crypto_intro_2')); ?></span><br>
          <span><?php echo e(trans('top.top_crypto_intro_3')); ?></span>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-md-12  col-sm-12 col-lg-12 col-xs-12  text-center-sp">
          <a href="<?php echo e($row[1]); ?>" class="common-button">新規口座開設</a>
        </div>
        <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </div>
      ...
      <div class="row hidden-xs" id="sec5-bg-image">
        <div class="sec5-text">
          <span class="sec5-heading"><?php echo e(trans('top.top_best_title_1')); ?></span><br><br>
          <span><?php echo e(trans('top.top_best_content_1')); ?></span><br>
        </div>
        <div class="sec5-text">
          <span class="sec5-heading"><?php echo e(trans('top.top_best_title_2')); ?></span><br><br>
          <span><?php echo e(trans('top.top_best_content_2')); ?></span><br>
        </div>
...
</script><?php /**PATH E:\Gitub project\good\resources\views/top.blade.php ENDPATH**/ ?>