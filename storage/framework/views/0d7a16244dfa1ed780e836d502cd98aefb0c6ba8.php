...
<div>
    ...
    <div>
        ...
        <div class="col-sm-11 col-xs-10 pad0">
            <input type="text" value="test" class="small_text_box" readonly />
        </div>
...
</div><?php /**PATH /Applications/MAMP/htdocs/GoodEnough3/resources/views/deposits_parts/cryptocurrency.blade.php ENDPATH**/ ?>