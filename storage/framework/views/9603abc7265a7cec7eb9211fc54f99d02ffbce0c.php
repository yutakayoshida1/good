	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="col-16 mx-auto ajax needs-validation" action="<?php echo e(route('inquiry')); ?>"
					enctype="multipart/form-data" method="POST">
					<?php echo csrf_field(); ?>
					<input type="hidden" name="form[type]" value="contact">
					<input type="hidden" name="thisRouteName" value="<?php echo e($thisRouteName); ?>">
...
</div><?php /**PATH E:\ready\japan project\laravel design\goodenoughtreasure.com\resources\views/layouts/inquery_form.blade.php ENDPATH**/ ?>