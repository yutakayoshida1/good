      ...
      <div class="row">
        ...
        <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12  my-page-main-content">
          ...
          <div class="mypage-detail-wrapper">
            ...
            <p class="subcontent">反映までの時間 : 最大３営業日　　振り込み手数料 : お客様負担でお願いいたします。<p>
            <p class="subcontent">三菱 UFJ 銀行　福岡支店　普通口座　口座番号 9999999 口座名義　カ）グツドイナフエフエツクス</p>
          
            <a href="#" class="my-page-button my-page-danger-button">振り込みに際してのご注意点</a>

            <p class="subcontent-red">            ★必ず振り込み名には登録口座のお名前と MT４口座番号をご入力下さいますよう
            　お願い申し上げます。</p>
            <p class="subcontent-red">            ★MT４口座番号が入力されておりませんと残高に反映できない場合がございますので
            　ご注意下さい。</p>
...
<?php /**PATH /home/r9920488/public_html/goodenoughtreasure.com/resources/views/my_page/deposit.blade.php ENDPATH**/ ?>