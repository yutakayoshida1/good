      ...
      <div class="row">
          ...
          <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12   my-page-main-content" >
            <div  class="col-md-6 col-lg-6 col-sm-6 col-xs-12 d-flex-around">
              ...
              <a href="<?php echo e(url('/my-history')); ?>" class="mypage-menu mypage-menu-active">履  歴</a>
...
<?php /**PATH E:\Gitub project\good\resources\views/my_page/history.blade.php ENDPATH**/ ?>