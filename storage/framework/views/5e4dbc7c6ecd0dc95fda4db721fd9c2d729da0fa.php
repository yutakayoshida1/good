...
<html lang="ja" class="cabinet sr"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<div class="container">
		<div class="row">
			<div class="col-12 text-center my-5">
				<h1 style="width:60%;float:left;text-align:right;">会員ページ</h1>
                <a style="float:right;" href="<?php echo e(route('affiliate')); ?>" class="btn btn-primary mx-auto btn-slide mt-2 mx-0">アフィリエイトパートナー登録</a>
			</div>
		</div>
	</div>
    ...
    </body></html><?php /**PATH /Applications/MAMP/htdocs/TasnicCapital/resources/views/personal/summary.blade.php ENDPATH**/ ?>