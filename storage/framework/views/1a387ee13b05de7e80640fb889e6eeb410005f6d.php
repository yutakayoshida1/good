...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-1 col-xs-0 d-none d-md-block">
                
            </div>
            <div class="col-md-3 col-xs-12 d-none d-md-block margintop">
                <?php echo $__env->make('personal.summary_main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <div class="col-md-4 col-xs-0 d-none d-md-block">
...
</html><?php /**PATH /Applications/MAMP/htdocs/GoodEnough3/resources/views/personal/summary2.blade.php ENDPATH**/ ?>