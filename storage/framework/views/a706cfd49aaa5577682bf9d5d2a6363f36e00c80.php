<div class="container black_back">
    ...
    <div class="row">
		<div class="col-md-9 menu active">
	...
	<div class="row textcenter">
		...
		<div class="col-md-2 menu active">
			<img src="<?php echo e(asset('img/basic/logo.png')); ?>" class="logo">
		</div>
		<div class="col-md-5 copyright">
			<span> Copyright © 2014-2021 Titan FX. All rights reserved. </span>
		</div>
	</div>
</div><?php /**PATH /Applications/MAMP/htdocs/GoodEnough3/resources/views/layouts/footer.blade.php ENDPATH**/ ?>