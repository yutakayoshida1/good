...
<form method="POST" action="<?php echo e(route('setting-confirm')); ?>" enctype="multipart/form-data" onSubmit="return IdAuth1();">
<?php echo csrf_field(); ?>
<div class="row">
...
<form method="POST" action="<?php echo e(route('setting-confirm')); ?>" enctype="multipart/form-data" onSubmit="return IdAuth2();">
<?php echo csrf_field(); ?>
<div class="row">
    <div class="col-md-4 pad_vertical">
        <div class="green_back_box small_text_box" />
...
<?php /**PATH E:\Gitub project\good\resources\views/personal/setting_main.blade.php ENDPATH**/ ?>