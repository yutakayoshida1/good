		...
		<div class="container my-6">
			...
			<div class="col-md-12">
				...
				<div class="accordion" id="accordionExample">
					<div>
						<a href="#faq1" class="btn btn-block" data-toggle="collapse">1. アカウントへの入出金はどうすればよいですか？</a>
						<div id="faq1" class="collapse">
							<p><br> いくつかの方法を使用してアカウントに入出金を行うことができます。会員ページの入出金ページをご覧ください。<br></p>
						</div>
					</div>
					<div>
						<a href="#faq2" class="btn btn-block" data-toggle="collapse">2. 口座から別の口座に資金を送金するにはどうすればよいですか？</a>
						<div id="faq2" class="collapse">
							<p><br> はい、私達は香港の承認されたブローカーディーラーです。<br></p>
						</div>
					</div>
					<div>
						<a href="#faq3" class="btn btn-block" data-toggle="collapse">3. GOOD ENOUGH FXは承認されたサイトですか？</a>
						<div id="faq3" class="collapse">
							<p><br>会員ページの資金移動ページから可能です。<br></p>
						</div>
					</div>
					<div>
						<a href="#faq4" class="btn btn-block" data-toggle="collapse">4. 私の資金は安全で分散されていますか？</a>
						<div id="faq4" class="collapse">
							<p><br>はい、すべての資金は分散された口座、ウォレットに保管されており、企業の資金とは完全に分離されており、混合されていません<br></p>
						</div>
					</div>
					<div>
						<a href="#faq5" class="btn btn-block" data-toggle="collapse">5. デモアカウントを提供していますか？</a>
						<div id="faq5" class="collapse">
							<p><br>はい、ここでデモアカウントにサインアップできます：<a href="<?php echo e(route('demo')); ?>">デモ口座開設ページ<br></p>
						</div>
					</div>
					<div>
						<a href="#faq6" class="btn btn-block" data-toggle="collapse">6. どのプラットフォームを提供していますか？</a>
					...
					<div>
						<a href="#faq7" class="btn btn-block" data-toggle="collapse">7. 暗号資産取引を提供していますか？</a>
						<div id="faq7" class="collapse">
							<p><br>はい、さまざまな暗号通貨ペアを提供しています。スプレッドと実行を表示するには、当社のプラットフォームをダウンロードしてください。<br></p>
						</div>
					</div>
					<div>
						<a href="#faq8" class="btn btn-block" data-toggle="collapse">8. 私のアカウントを表示するためのWebベースのポータルを提供していますか？</a>
						<div id="faq8" class="collapse">
							<p><br>はい、クライアントキャビネットを提供しています。ここをクリックしてご覧ください。<br></p>
						</div>
					</div>
					<div>
						<a href="#faq9" class="btn btn-block" data-toggle="collapse">9. WebサイトでSWAPSを表示しますか？</a>
						<div id="faq9" class="collapse">
							<p><br>はい、そうです。このリンクをご覧ください：外国為替ロールオーバー率<br></p>
						</div>
					</div>
					<div>
						<a href="#faq10" class="btn btn-block" data-toggle="collapse">10. GOOD ENOUGH FXの流動性プロバイダーは誰ですか？</a>
					...
					<div>
						<a href="#faq11" class="btn btn-block" data-toggle="collapse">11. MAM口座開設申請はどうしたらよいですか？</a>
					...
					<div>
						<a href="#faq12" class="btn btn-block" data-toggle="collapse">12. レバレッジ設定が変更されることはありますか？</a>
						<div id="faq12" class="collapse">
							<p><br>金額上限により設定値が変更されます。注文が200万円以上で200倍、500万円以上で100倍に変更されます。<br></p>
						</div>
					</div>
					<div>
						<a href="#faq13" class="btn btn-block" data-toggle="collapse">13. 入金が反映されるまで、どれくらい時間がかかりますか？</a>
...
</html><?php /**PATH E:\ready\japan project\laravel design\goodenoughtreasure.com\resources\views/terms/faq.blade.php ENDPATH**/ ?>