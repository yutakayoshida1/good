...
<head>
	...
	<title>新規口座開設 | Tasnic-Capital</title>
      ...
      <div class="modal-body">
      	 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true" style="color: black; font-size: xx-large;">&times;</span>
					...
					<a class="btn-default h-100 center-with-flex" href="https://www.Tasnic-Capital.com/ja/accounts/funding?ref=latam" target="_blank">入出金</a></li>
		...
		<div class="modal-body">
			<form method="POST" id="modalContactForm" action="?processform=support&formtype=contact" class="ajax needs-validation" novalidate>
				...
				<button type="submit" class="btn-primary" style="float:left;">送信する</button>
								<input type="hidden" name="backend[form_link]" value="https://www.Tasnic-Capitallatam.com/ja/ja/forms/accounts/">
	    ...
	    <div class="container">
	      <div class="row mt-5">
	        <!-- <div class="col-sm-8 center-with-flex">
	        	<img src="https://www.Tasnic-Capitallatam.com/ja/assets/img/Tasnic-CapitalSymbol.svg" class="mx-auto d-block mb-2 col-4">
	        </div> -->
	        <div class="col-sm-12 center-with-flex mt-6">
	              <h1 class="text-white text-center"><strong>新規口座開設</strong><br>Tasnic-Capitalの口座開設はカンタンです</h1>
	        </div>
	      </div>
	    </div>
	  </section>
	      ...
	      <div class="container">
	          <div class="row introductionTeam">
	              ...
	              <div class="col-12">              
	                  ...
	                  <p class="text-center">En Tasnic-Capital una cuenta Real puede ser abierta en minutos.</p>
		            ...
		            <div class="col-md-3 p-3 card mb-5 shadow">
		                <div class="accountType">
		                    ...
		                    <a href="<?php echo e(route('individual')); ?>" target="_self" rel="nofollow">
		                        <button class="btn-lg btn-primary_blue col-md-12 mt-4">Tasnic-Capital 個人口座</button>
		                    </a>
		                </div>
		            </div>
		             ...
		             <div class="col-md-3 offset-md-1 p-3 card mb-5 shadow">
		                <div class="accountType">
		                    ...
		                    <a href="<?php echo e(route('corporate')); ?>" target="_self" rel="nofollow">
		                        <button class="btn-lg btn-primary_blue col-md-12 mt-4">Tasnic-Capital 法人口座</button>
		                    </a>
		                </div>
		            </div>
		            		        </div>
...
</html><?php /**PATH /Applications/MAMP/htdocs/TasnicCapital/resources/views/account.blade.php ENDPATH**/ ?>