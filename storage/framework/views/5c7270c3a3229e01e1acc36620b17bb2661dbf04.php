		...
		<div class="row no-gutters w-90">
			...
			<div class="col-2 logoImg py-4 mr-auto headerlogo">
				<a href="<?php echo e(route('top')); ?>">
					<img src="<?php echo e(asset('img/logo/TN_LOGO.png')); ?>" class="img-fluid">
				</a>
			</div>
...
</style><?php /**PATH E:\ready\japan project\laravel design\goodenoughtreasure.com\resources\views/layouts/header2.blade.php ENDPATH**/ ?>