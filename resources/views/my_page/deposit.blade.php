      ...
      <div class="row">
        ...
        <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12  my-page-main-content">
          ...
          <div style="deposit-menu-wrapper ">
            ...
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 d-flex-around margin-top-zero">
              <a href="{{url('/my-transfer')}}" class="mypage-menu deposit-menu" style="visibility:hidden;">暗号通貨入金</a>
              <a href="{{url('/my-additional')}}" style="visibility:hidden" class="mypage-menu deposit-menu">出　金</a>
            </div>
          </div>
