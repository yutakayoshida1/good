        ...
        <div class="col-md-9 col-lg-9 col-sm-9 col-xs-12  my-page-main-content">
          ...
          <div style="deposit-menu-wrapper">
            <div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 d-flex-around xxxxxx margin-top-zero">
              <a href="{{url('/my-deposit/withdrawal')}}" class="mypage-menu deposit-menu  mypage-menu-active">銀行入金</a>
              <a href="{{url('/my-deposit/withdrawal/credit')}}" class="mypage-menu deposit-menu">クレジット入金</a>
            </div>
            ...
            <form method="POST" action="{{route('withdrawal-application2')}}" enctype="multipart/form-data" class="register_form" onSubmit="return IdAuth();" data-addbankaction="{{route('add-bank')}}" data-withdrawaction="{{route('withdrawal-application2')}}">
              ...
              <div class="my-page-form-group" style="margin: auto;">
                <div class="d-flex-right">
                  <span>出金元口座番号</span> <span class="my-page-number">{{$account_number}}</span>
                </div>
