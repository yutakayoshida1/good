					...
					<div class="col-sm-4 blackBG">
						<blockquote>
							<div class="contentQuote">
																	<p class="text-white">Apply for a Real Account with good-enough is very simple and it takes just a few minutes. Just two steps to follow!</p>
															</div>
						</blockquote>
					</div>
				</div>
...
出金申請受付致しました。<br>
通常３営業日内に完了いたしますが週末を挟む場合はお時間がかかりますのでご留意ください</h1>
									</div>

				<div class="col-md-4 box-2">

																		<p class="text-center">We will send you an email with your account details in the next 24 hours.</p>
