...
class IndividualAccountsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('individual.register')->with([
            "global" => $global,
         ]);
    ...
    public function testcode(Request $request)
    {
        ...
        return view('registerlayout.testcode')->with([
    ...
    public function confirm(Request $request)
    {
        ...
        self::sendMailForTellingRegistrationInfo($email, $account_num, $password, $name, $tel, $leverage);
    ...
    public function ThankyouPageTest(Request $request)
    {
        $currentPath = asset('static')."/ja/forms/accounts/individual-confirm";
    ...
    public function sendMailForTellingLoginInfo($to, $account_num, $password, $name){
        ...
        $subject = "GOOD ENOUGH・個人口座開設申請を受け付けました";
    ...
    public function sendMailForTellingRegistrationInfo($email, $account_num, $password, $name,$tel, $leverage){
        $subject = "GOOD ENOUGH・個人口座登録";
        $from = EmailTemplate::sendnotificationEmail;
        $to = EmailTemplate::personalAccountRegistration;

        $cryptWithdrawalToCustomer = EmailTemplate::registerIndividualAccountToOperator($name,$email,$tel,null, $leverage);
