...
class PersonalPageController extends Controller
{
    ...
    public function Summary(Request $request)
    {
        ...
        return view('personal.summary2')->with([
    ...
    public function History(Request $request)
    {
        ...
        return view('personal.history')->with([
            "global" => $global,
            "personal" => $personal,
    ...
    public function WithdrawalApplication(Request $request)
    {
        if($request->howdo == "bank"){
            self::sendMailForTellingBankWithdrawalToCustomer($request->email, $request->name, $request->howmuch);
            self::sendMailForTellingBankWithdrawalToOperator($request->account_number, $request->name, $request->email, $request->phone, $request->howmuch, $request->howdo, $request->receiver_name, $request->receiver_address, $request->receiver_accountnum, $request->receiver_bankname, $request->receiver_bankbranch, $request->receiver_bankkind, $request->receiver_bankaddress, $request->receiver_swift, $request->receiver_bikou);
        }else{
            self::sendMailForTellingWithdrawalToCustomer($request->email, $request->name, $request->howdo, $request->howmuch, $request->receiver_cryptaddress);
            self::sendMailForTellingWithdrawalToOperator($request->account_number, $request->name, $request->email, $request->phone, $request->howmuch, $request->howdo, $request->receiver_cryptaddress);
        }
    ...
    public function Setting(Request $request)
    {
        ...
        return view('personal.setting')->with([
            "global" => $global,
            "personal" => $personal,
        ]);
    }
    ...
    public function Transfer(Request $request)
    {
        ...
        return view('personal.transfer')->with([
            "global" => $global,
            "personal" => $personal,
    ...
    public function AddAccount(Request $request)
    {
        ...
        return view('personal.addaccount')->with([
            "global" => $global,
            "personal" => $personal,
...
';
    ...
    */
    ...
    private function sendMailForTellingWithdrawalToOperator($accountnum, $name, $email, $tel, $howmuch, $howdo, $address){
        ...
        $header = EmailTemplate::header($name);
        $cryptWithdrawalToOperator = EmailTemplate::cryptWithdrawalToOperator($accountnum, $name, $email, $tel, $howmuch, $howdo, $address);
        $noreplyFooter = EmailTemplate::noreplyFooter($name);
        $signature = EmailTemplate::signature($name);
    ...
    private function sendMailForTellingBankWithdrawalToOperator($accountnum, $name, $email, $tel, $howmuch, $howdo, $receiver_name, $receiver_address, $receiver_accountnum, $receiver_bankname, $receiver_bankbranch, $receiver_bankkind, $receiver_bankaddress, $receiver_swift, $receiver_bikou){
        ...
        $header = EmailTemplate::header($name);
        $cryptWithdrawalToOperator = EmailTemplate::bankWithdrawalToOperator($accountnum, $name, $email, $tel, $howmuch, $howdo, $receiver_name, $receiver_address, $receiver_accountnum, $receiver_bankname, $receiver_bankbranch, $receiver_bankkind, $receiver_bankaddress, $receiver_swift, $receiver_bikou);
        $noreplyFooter = EmailTemplate::noreplyFooter($name);
        $signature = EmailTemplate::signature($name);
